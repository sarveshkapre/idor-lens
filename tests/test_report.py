...
def test_report_renders_html(tmp_path: Path) -> None:
    ...
    inp.write_text(
        "\n".join(
            [
                '{"endpoint":"/a","method":"GET","url":"https://x/a","victim_status":200,"attacker_status":200,"vulnerable":true,"confidence":"high","body_match":true,"reason":"ok","elapsed_ms":5}',
                ...
                '{"endpoint":"</script>","method":"GET","url":"https://x/c","victim_status":0,"attacker_status":0,"vulnerable":false,"confidence":"none","body_match":false,"reason":"<b>err</b>","elapsed_ms":1}',
            ]
        )
        + "\n",
        encoding="utf-8",
